  ...
  <div class="componentWaper">
    ...
    <div id="forTable" v-if="!isOk">
      ...
      >
        ...
        <el-form-item size="mini" label="是否显示银行过渡页" class="is50">
          <el-radio-group v-model="ruleForm.excessPage" class="isInput">
            <el-radio-button label="是" class="isRadio"></el-radio-button>
            <el-radio-button label="否" class="isRadio"></el-radio-button>
          </el-radio-group>
        </el-form-item>

        <el-form-item label="置顶序号" class="is50" prop="topNo">
          <el-input type="number" clearable placeholder="请输入" v-model="ruleForm.topNo"></el-input>
        </el-form-item>

        <el-form-item size="mini" label="首页是否展示" class="is50">
          <el-radio-group v-model="ruleForm.isIndex" class="isInput">
            <el-radio-button label="是" class="isRadio"></el-radio-button>
            <el-radio-button label="否" class="isRadio"></el-radio-button>
          </el-radio-group>
        </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        ...
        channel_coverage: ["Android市场"], // 渠道覆盖类型
        product_coverage: ["理财产品"], //产品覆盖类型
        ...
        if (valid) {
          ...
          if (this.fromHttp) {
            ...
            obj = {
              ...
              subType: step1.type,
              subTypeLabel: "",
              aum: step1.aum ? step1.aum : 0,
              logo: step1.logo,
              star: step1.star,
              starLabel: "",
              starRatingDesc: step1.starRatingDesc,
              description: step1.description,
              synopsis: step1.synopsis,
              ...
              configuration: {
                isIndex: this.ruleForm.isIndex === "是" ? "YES" : "NO",
                ...
                excessPage: this.ruleForm.excessPage === "是" ? "YES" : "NO",
