  ...
  methods: {
    next() {
      ...
      let obj = {
        ...
        institutionName: step1.institutionName,
        lockinPeriod: +step1.institutionName,
        name: step1.name,
        appInfo: {
        ...
        purchaseAmount: +step1.purchaseAmount,
        redemptionDate: step1.redemptionDate,
        yield: {
          onThe7thOfTheYearYield: +step1.yield.onThe7thOfTheYearYield,
          thousandsOfYearsYields: +step1.yield.thousandsOfYearsYields
        },
