  ...
  <div class="componentWaper">
    ...
    <div style="overflow:auto;">
      ...
      >
        ...
        <el-form-item label="起购金额" class="is50">
          <el-input
            type="number"
            class="isInput"
            clearable
        ...
        <el-form-item label="赎回到帐日" class="is50">
          <el-input
            class="isInput"
            clearable
        ...
        <el-form-item label="锁定期" class="is50">
          <el-input
            class="isInput"
            clearable
        ...
        <el-form-item label="买入" class="is50">
          <el-input
            type="number"
            class="isInput"
            clearable
        ...
        <el-form-item label="手续费用" class="is50">
          <el-input
            type="number"
            class="isInput"
            clearable
        ...
        <el-form-item label="7日年化收益率" class="is50">
          <el-input
            class="isInput"
            clearable
            v-model="ruleForm.yield.onThe7thOfTheYearYield"
            placeholder="请输入"
            type="number"
          ></el-input>
          <span class="isA">%</span>
        ...
        <el-form-item label="万分年化收益率" class="is50">
          <el-input
            class="isInput"
            clearable
            v-model="ruleForm.yield.thousandsOfYearsYields"
            placeholder="请输入"
            type="number"
          ></el-input>
          <span class="isA">%</span>
        ...
        <el-form-item label="收益规则">
          <quill-editor
            class="isInput"
            v-model="ruleForm.yieldRule"
          >
          </quill-editor>
        </el-form-item>
