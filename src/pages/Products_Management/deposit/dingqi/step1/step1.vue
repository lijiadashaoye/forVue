  ...
  <div class="componentWaper">
    ...
    <div style="overflow:auto;" id="forTable">
      ...
      >
        ...
        <el-form-item label="利率别名" class="is50" prop="typeAlias">
          <el-input
            class="isInput"
            clearable
            placeholder="请输入"
        ...
        <el-form-item label="收益返还方式" style="position:relative" class="is50">
          <el-select filterable class="isInput" clearable placeholder="请选择" v-model="ruleForm.interestModeWay">
            <el-option
              size="mini"
