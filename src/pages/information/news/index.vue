<template>
    <div class="componentWaper">
        ...
        <el-dialog :title="updateFlag ? '修改新闻' : '新增新闻'" :visible.sync="dialogFormVisible" :close-on-click-modal='false' :before-close="closeDialog">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    riskStatus: [{ required: true, message: "请选择", trigger: "blur" }],
                    recommendStatus: [{ required: true, message: "请选择", trigger: "blur" }],
                    loadNum: [
