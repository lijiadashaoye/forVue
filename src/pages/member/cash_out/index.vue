<template>
    <div class="componentWaper">
        <div id="forHeader">
            ...
            <el-form :inline="true" :model="searchForm" :rules="searchRules" ref='searchForm' class="demo-form-inline">
                ...
                <el-form-item label='交易状态' prop='newestStatus'>
                    <el-select v-model="searchForm.newestStatus" placeholder="请选择" size='mini' filterable clearable>
                        <el-option
        ...
        <div id="forTable">
            <isTable
                :inputData='this.$store.state.cashOut.cashList'
                @tableEmit='tableEmit'
            />
        </div>
    </div>
...
import { cash_out_payment, cash_out_applyFor, cash_out_turnDown, cash_out_operation, cash_out_export } from '../../../api/setting_use';
export default {
    components: {
        isTable
    },
                ...
                cash_out_payment(obj).then(res=> {
                    if(res && res.success) {
                        this.getList({
                            ...
                            pageSize: this.$store.state.cashOut.cashList.pageSize,
                            createStart: this.searchForm.createTime[0] != null && this.searchForm.createTime[0] != ''? this.searchForm.createTime[0] : null,
                            createEnd: this.searchForm.createTime[1] != null && this.searchForm.createTime[1] != ''? this.searchForm.createTime[1] : null,
                            updateStart: this.searchForm.updateTime[0] != null && this.searchForm.updateTime[0] != '' ? this.searchForm.updateTime[0] : null,
                            updateEnd: this.searchForm.updateTime[1] != null && this.searchForm.updateTime[1] != '' ?this.searchForm.updateTime[1] : null,
                            serialNum: this.searchForm.serialNum != '' && this.searchForm.serialNum != null ? this.searchForm.serialNum : null,
                            receivingCard: this.searchForm.receivingCard != '' && this.searchForm.receivingCard != null ? this.searchForm.receivingCard : null,
                            newestStatus: this.searchForm.newestStatus != '' && this.searchForm.newestStatus != null ? this.searchForm.newestStatus : null
                        });
                        this.$message({
                            type: 'success',
                            message: '交易成功!'
