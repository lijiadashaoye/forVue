    ...
    <div id="forTable" style="padding-bottom:0;">
      <div class="sandow2">
        <el-form :inline="true" ref="ruleForm" :model="ruleForm" label-suffix=" :">
          ...
          <el-form-item label="银行产品" size="mini" label-width="78px">
            <el-select
              filterable
              multiple
              v-model="ruleForm.bankProduct"
              clearable
              placeholder="请选择"
              style="width:300px"
            >
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      if (this.ruleForm.bankProduct.length) {
        obj.bankProduct = this.ruleForm.bankProduct;
      }
