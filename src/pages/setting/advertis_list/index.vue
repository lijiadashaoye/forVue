  ...
  <div class="componentWaper">
    <div id="forHeader">
      ...
      <div class="explosiveAdd">
        <el-button type="primary" size="mini" @click="addActivityButton">新建启动页</el-button>
      </div>
    </div>

    <div id="forTable">
      <isTable :inputData="this.$store.state.advertis.advertisList" @tableEmit="tableEmit" />
    </div>
