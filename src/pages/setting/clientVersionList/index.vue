<template>
  <div class="componentWaper">
    <div id="forHeader">
      ...
      <div class="adverAdd">
        <el-select filterable size="mini" v-model="platformCode" @change="platformChangeFn">
          <el-option
        ...
        <el-input
          ...
          @input="search"
        ></el-input>
        <el-button type="primary" size="mini" @click="addAdverFn">新增</el-button>
        <el-button type="warning" size="mini" @click="refreshFn">刷新</el-button>
      </div>
    </div>
      ...
      >
        ...
        >
          ...
          <el-form-item label="弹框提示背景图" prop="backgroundUrl">
            ...
            >
              <img
                v-if="ruleForm.backgroundUrl"
                :src="ImgBaseUrl + ruleForm.backgroundUrl"
                class="avatar"
              />
              <div v-else>
                <el-button>
...
export default {
  ...
  data() {
    return {
      ...
      rule: {
        ...
        versionNo: [{ required: true, message: "请输入版本", trigger: "blur" }],
        versionName: [
  ...
  mounted() {
    ...
    if (this.platformCode == "android") {
      this.$store.state.clientVersion.clientVersionList.data.title.splice(
        2,
        0,
        {
          title: "渠道",
      ...
      this.$refs[form].validate(valid => {
        if (valid) {
          let params = {
            ...
            platformName:
              this.ruleForm.platformCode == "android" ? "安卓" : "苹果",
            appChannelCode: this.ruleForm.appChannelCode,
            appChannelName:
              this.ruleForm.appChannelCode == "bicai" ? "比财" : "安财",
