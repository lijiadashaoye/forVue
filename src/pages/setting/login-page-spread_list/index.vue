<template>
  <div class="componentWaper">
    <div id="forHeader">
      ...
      <div class="adverAdd">
        <el-button type="primary" size="mini" @click="addloginPage">创建登录页</el-button>
      </div>
    </div>

    <div id="forTable">
      <isTable :inputData="this.$store.state.loginSpread.loginSpreadList" @tableEmit="tableEmit" />
    </div>

    <!-- 修改/详情的弹框 -->
    <el-dialog
      :close-on-click-modal="false"
      :title=" updataFlag ? '修改登录页' : '详情' "
    ...
    <!-- 更改状态 弹框 -->
    <el-dialog :close-on-click-modal="false" title="状态更新" :visible.sync="statusVisible" width="40%">
          ...
          loginSpread_status_upd({
            ...
            .then(res => {
              if (res && res.success) {
                ...
                this.getLoginSpreadListData({
                  pageNum: this.$store.state.loginSpread.loginSpreadList
                    .pageNum,
                  pageSize: this.$store.state.loginSpread.loginSpreadList
                    .pageSize
                });
              }
            })
