    ...
    <el-form
     ...
     >
      <el-form-item label="银行名称:" prop="prodectBankId">
        <el-select
          filterable
          v-model="ruleForm.prodectBankId"
          placeholder="请输入名称"
          :disabled="detailFlag"
        >
          <el-option
      ...
      <el-form-item label="银行LOGO:" prop="LogoUrl">
        ...
        >
          <img
            v-if="ruleForm.LogoUrl != '' && logoFlag == false"
            :src="ImgBaseUrl + ruleForm.LogoUrl"
            class="avatar"
          />
      ...
      <el-form-item label="银行背景图:" prop="bgUrl">
        ...
        >
          <img
            v-if="ruleForm.bgUrl !='' && bgFlag == false"
            :src="ImgBaseUrl + ruleForm.bgUrl"
            class="avatar"
          />
