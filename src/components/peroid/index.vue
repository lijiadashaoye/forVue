  ...
  >
    ...
    <el-form-item label="地区:" prop="peroidType">
      <el-radio-group v-model="ruleForm.peroidType">
        <el-radio label="PETTY">中国</el-radio>
        <el-radio label="FINANCING">香港</el-radio>
      </el-radio-group>
    </el-form-item>

    <el-form-item label="开始天:" prop="startDay">
      <el-input
        v-model.number="ruleForm.startDay"
        min="0"
        placeholder="只允许填入数字"
        maxlength="8"
        show-word-limit
    ...
    <el-form-item label="结束天:" prop="endDay">
      <el-input
        v-model.number="ruleForm.endDay"
        min="0"
        placeholder="只允许填入数字"
        maxlength="8"
        show-word-limit
    ...
    <el-form-item label="每页条数:" prop="indexPageSize">
      <el-input
        v-model.number="ruleForm.indexPageSize"
        min="0"
        placeholder="只允许填入数字"
        maxlength="8"
        show-word-limit
