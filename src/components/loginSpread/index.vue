<template>
  ...
  >
    ...
    <div class="bottomBtn">
      ...
      <el-button size="mini" v-if="!detailFlag" @click="cancel('ruleForm')">取消</el-button>
...
export default {
  ...
  mounted() {
    this.isAdd =
      sessionStorage.getItem("now") === "/home/setting/login-page-spread/add";
