  ...
  >
    ...
    <el-form-item label="类型" prop="showType">
      <el-radio-group
        ...
        :disabled="showTypeFlag"
        @change.native="showTypeChange(ruleForm.showType)"
      >
    ...
    <el-form-item
      label="广告图片"
      prop="launchAdvertisingDetails"
      v-if="this.ruleForm.showType == 'OPENSCREEN'"
    >
      <el-upload
        class="upload-demo"
        auto-upload
    ...
    <el-form-item
      label="分辨率"
      prop="resolution"
      v-if="this.ruleForm.showType === 'FLASHSCREEN' || this.ruleForm.showType === 'VIDEO'"
    >
    ...
    <el-form-item label="闪屏时间" prop="displayTime" v-if="this.ruleForm.showType === 'FLASHSCREEN'">
      <el-input v-model="ruleForm.displayTime" placeholder="只能输入数字">
    ...
    <el-form-item
      label="点击效果连接位置"
      prop="productType"
      v-if="this.ruleForm.showType === 'FLASHSCREEN'"
    >
      <el-select
        filterable
    ...
    <el-form-item
      label="网址链接"
      prop="linkUrl"
      v-if="this.ruleForm.showType === 'FLASHSCREEN' && this.inputFlag"
    >
    ...
    <el-form-item label="关联产品" prop="linkId" v-else-if="this.ruleForm.showType === 'FLASHSCREEN'">
      <el-select
        ...
        placeholder="请选择产品名称"
      >
        <el-option v-for="(item,ind) in productOpt" :key="ind" :label="item.name" :value="item.id">
    ...
    <el-form-item label="广告" prop="flashScreenUrl" v-if="this.ruleForm.showType === 'FLASHSCREEN'">
      ...
      >
        <img
          v-if="ruleForm.flashScreenUrl"
          :src="ImgBaseUrl + ruleForm.flashScreenUrl"
          class="avatar"
        />
        <div v-else>
          <el-button>
    ...
    <el-form-item
      v-show="this.ruleForm.showType === 'FLASHSCREEN' && this.ruleForm.pushUser == 'PORTION'"
      label-width="0"
    >
      <h4>推广地区选择</h4>
    </el-form-item>
    ...
    <el-form-item
      label="选择省份"
      prop="provinceList"
      v-if="this.ruleForm.showType === 'FLASHSCREEN' && this.ruleForm.pushUser === 'PORTION'"
    >
      <el-select
        filterable
  ...
  data() {
    return {
      ...
      rules: {
        ...
        launchAdvertisingDetails: [
          { required: true, message: "请上传开屏图片", trigger: "change" }
        ],
        resolution: [
          { required: true, message: "请选择分辨率", trigger: "change" }
        ],
        displayTime: [
          { required: true, message: "请输入闪屏时间", trigger: "blur" }
        ],
        productType: [
          { required: true, message: "请选择效果链接位置", trigger: "blur" }
        ],
        linkUrl: [
          { required: true, message: "请填写天传地址", trigger: "blur" }
        ],
        flashScreenUrl: [
        ...
        pushUser: [
          { required: true, message: "请选择推广用户", trigger: "change" }
        ],
  ...
  methods: {
    ...
    typeSelect(val) {
      ...
      if (
        ...
        this.ruleForm.productType != "undefined"
      ) {
        this.productCodeFlag = false;
    ...
    save(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          //产品
          if (
            this.ruleForm.productType != "EXTERNAL_LINK" &&
            this.ruleForm.linkId != "" &&
              ...
              productRelationDetailsVo: {
                ...
                productName:
                  this.productName != null && this.productName != ""
                    ...
                    : null,
                linkUrl:
                  this.ruleForm.linkUrl != null && this.ruleForm.linkUrl != ""
                    ? this.ruleForm.linkUrl
                    : null,
                linkId:
                  this.ruleForm.linkId != null && this.ruleForm.linkId != ""
                    ? this.ruleForm.linkId
                    : null,
                modelType: "LAUNCHPAGE",
                id:
