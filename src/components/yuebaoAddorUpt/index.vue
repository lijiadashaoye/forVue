<template>
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" width="320px">
    <el-form-item label="收益日期" prop="rateDate">
      <el-date-picker type="date" v-model="ruleForm.rateDate" placeholder="选择日期"></el-date-picker>
    </el-form-item>
